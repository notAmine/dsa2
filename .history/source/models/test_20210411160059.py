...
def get_dataset_split_for_model_petastorm(Xtrain, ytrain=None, pars:dict=None):
    ...
    :return:
    """
    s = r'C:\Users\TusharGoel\Desktop\Upwork\project4\dsa2\datasets\parquet\f01.parquet'
...
if os.path.exists(r'C:\Users\TusharGoel\Desktop\Upwork\project4\dsa2\datasets\parquet\f01.parquet'):
