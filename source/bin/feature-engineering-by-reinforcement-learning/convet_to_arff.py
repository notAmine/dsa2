...
fileToRead = "Boston.csv"  #csv file name or absolute path to be open.
fileToWrite = "boston_housing.arff" #name as how you'll save your arff file.
relation = "Boston Housing Data" #how you'll like to call your relation as.
